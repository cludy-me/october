...
return [
    ...
    'editor' => [
        'settings' => 'Settings',
        'title' => 'Title',
        'title_comment' => 'Make sure to keep the ideal length no more than 55-60 characters, including spaces.',
        ...
        'meta_description_comment' => 'Make sure to keep the ideal length no more than 120-160 characters, including spaces.',
        'meta_keywords' => 'Meta Keywords',
        'meta_robots_index' => 'Robot Index',
        'meta_robots_follow' => 'Robot Follow',
        'canonical_url' => 'Canonical URL',
        'redirect_url' => 'Redirect URL',
        'enable_og' => 'Use Open Graph',
        'enable_og_comment' => 'Open Graph <a href="https://developers.facebook.com/tools/debug/og/object/" target="_blank">debug tool</a>',
        'og_title' => 'Open Graph Title',
        'og_image' => 'Open Graph Image',
        'og_image_comment' => 'Minimum size: 200px by 200px. Recommended size: For the most impact on Facebook, make images at least 600px by 315px and, ideally, 1200px by 630px. Images below this minimum size will create smaller cards.',
        'og_description' => 'Open Graph Description',
        'og_description_comment' => 'Make sure to keep the ideal length no more than 160-200 characters, including spaces.',
        'markup' => 'Markup',
        'code' => 'Code',
        'content' => 'Content',
        'enabled_in_sitemap' => 'Add to the sitemap.xml',
        'enabled_in_sitemap' => 'Page will appear in the sitemap.xml',
        'hidden' => 'Hidden',
        ...
        'sitemap' => 'Sitemap',
        'enabled_in_sitemap' => 'Enable in the sitemap.xml',
        'enabled_in_sitemap_comment' => 'Page will appear in the sitemap.xml',
        'sitemap_changefreq' => 'Changing frequency',
        'sitemap_changefreq_comment' => 'Tell search engines how frequently this page changes',
        'sitemap_priority' => 'Priority',
        'sitemap_priority_comment' => 'Rank the importance of the page to search engines',
    ],
    'asset' => [
        'menu_label' => 'Assets',
